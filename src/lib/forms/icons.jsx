/**
 * Form-card icons, keyed by the `icon` column in the `forms` table.
 * Plain module (no 'use client') so it renders from either environment.
 */
const ICONS = {
  ShoppingCart: (
...
export function FormIcon({ name, size = 24 }) {
